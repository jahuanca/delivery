...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    nombre: {type: Sequelize.STRING(100), allowNull: false, validate:{isEmpty: false, len: [0,200]}},
    descripcion: {type: Sequelize.STRING(200), allowNull: true, validate: {notEmpty: true, len: [1,100]}},
